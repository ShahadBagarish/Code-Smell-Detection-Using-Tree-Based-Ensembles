...
# # Plotting the boxplot for cross-validation accuracy and AUC scores
# plt.figure(figsize=(8, 5))
# plt.boxplot([cv_accuracy_scores ], labels=['Accuracy'])
# plt.ylabel('Score')
# plt.title('Cross-Validation Accuracy and AUC Scores')
# plt.grid(True)
# plt.show()
...
plt.figure(figsize=(8, 5))
plt.boxplot([cv_accuracy_scores], labels=[classifier_names], vert=False)
plt.xlabel('Accuracy')
