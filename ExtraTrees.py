...
cv_accuracy_scores = cross_val_score(extra_trees_model, X, y, cv=10, scoring='accuracy')

# Perform 10-fold cross-validation for AUC
cv_auc_scores = cross_val_score(extra_trees_model, X, y, cv=10, scoring='roc_auc')
...
cv_predictions = cross_val_predict(extra_trees_model, X, y, cv=10)
