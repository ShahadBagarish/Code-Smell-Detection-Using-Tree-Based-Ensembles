...
cv_accuracy_scores = cross_val_score(random_forest_model, X, y, cv=10, scoring='accuracy')

# Perform 10-fold cross-validation for AUC
cv_auc_scores = cross_val_score(random_forest_model, X, y, cv=10, scoring='roc_auc')
